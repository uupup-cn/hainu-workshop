<template>
  <div class="login-wrap">
    <div class="login-card">
      ...
      <router-link to="/" class="back">先逛逛 <LucideIcon name="arrow-right" :size="14" /></router-link>
    </div>
  </div>
</template>
...
.back { display: inline-flex; align-items: center; gap: 2px; margin-top: 14px; font-size: 13px; }
</style>
