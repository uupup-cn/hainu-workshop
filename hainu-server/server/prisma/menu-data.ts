...
export function buildMenuSeed(): MenuSeedItem[] {
  const list: MenuSeedItem[] = [
    ...
    { menuKey: 'freshman:faq', menuName: 'FAQ管理', menuType: 'menu', parentId: 'freshman', icon: 'ri-question-line', path: 'faq', component: '', sortOrder: 3, isVisible: true },
    { menuKey: 'freshman:faq-category', menuName: 'FAQ分类管理', menuType: 'menu', parentId: 'freshman:faq', icon: 'ri-folder-line', path: 'faq/category', component: '/freshman/faq-category/index', sortOrder: 1, isVisible: true },
    { menuKey: 'freshman:faq-question', menuName: 'FAQ问题管理', menuType: 'menu', parentId: 'freshman:faq', icon: 'ri-question-line', path: 'faq/question', component: '/freshman/faq-question/index', sortOrder: 2, isVisible: true },
    { menuKey: 'freshman:roommate', menuName: '找室友', menuType: 'menu', parentId: 'freshman', icon: 'ri-user-add-line', path: 'roommate', component: '', sortOrder: 4, isVisible: true },
    { menuKey: 'freshman:roommate-settings', menuName: '功能配置', menuType: 'menu', parentId: 'freshman:roommate', icon: 'ri-settings-3-line', path: 'roommate/settings', component: '/freshman/roommate-settings/index', sortOrder: 1, isVisible: true },
    { menuKey: 'freshman:roommate-posts', menuName: '信息列表', menuType: 'menu', parentId: 'freshman:roommate', icon: 'ri-list-check', path: 'roommate/posts', component: '/freshman/roommate-posts/index', sortOrder: 2, isVisible: true },
    ...
    { menuKey: 'wise:phonebook', menuName: '电话簿', menuType: 'menu', parentId: 'wise', icon: 'ri-phone-line', path: 'phonebook', component: '', sortOrder: 2, isVisible: true },
    { menuKey: 'wise:phonebook-category', menuName: '分类管理', menuType: 'menu', parentId: 'wise:phonebook', icon: 'ri-folder-line', path: 'phonebook/category', component: '/wise/phonebook-category/index', sortOrder: 1, isVisible: true },
    { menuKey: 'wise:phonebook-entry', menuName: '条目管理', menuType: 'menu', parentId: 'wise:phonebook', icon: 'ri-contacts-line', path: 'phonebook/entry', component: '/wise/phonebook-entry/index', sortOrder: 2, isVisible: true },
    { menuKey: 'wise:calendar', menuName: '校历管理', menuType: 'menu', parentId: 'wise', icon: 'ri-calendar-line', path: 'calendar', component: '', sortOrder: 3, isVisible: true },
    { menuKey: 'wise:calendar-config', menuName: '校历配置', menuType: 'menu', parentId: 'wise:calendar', icon: 'ri-settings-line', path: 'calendar/config', component: '/wise/calendar-config/index', sortOrder: 1, isVisible: true },
    { menuKey: 'wise:calendar-view', menuName: '日历视图', menuType: 'menu', parentId: 'wise:calendar', icon: 'ri-calendar-2-line', path: 'calendar/view', component: '/wise/calendar-view/index', sortOrder: 2, isVisible: true },
    ...
    { menuKey: 'wise:bus', menuName: '校内班车', menuType: 'menu', parentId: 'wise', icon: 'ri-bus-line', path: 'bus', component: '', sortOrder: 5, isVisible: true },
    { menuKey: 'wise:bus-schedule', menuName: '班车时刻表', menuType: 'menu', parentId: 'wise:bus', icon: 'ri-bus-line', path: 'bus-schedule', component: '/wise/bus-schedule/index', sortOrder: 1, isVisible: true },
    { menuKey: 'wise:bus-station', menuName: '车站信息', menuType: 'menu', parentId: 'wise:bus', icon: 'ri-map-pin-line', path: 'bus-station', component: '/wise/bus-station/index', sortOrder: 2, isVisible: true },
    { menuKey: 'wise:bus-guide', menuName: '乘车指南', menuType: 'menu', parentId: 'wise:bus', icon: 'ri-road-map-line', path: 'bus-guide', component: '/wise/bus-guide/index', sortOrder: 3, isVisible: true },
    { menuKey: 'wise:campus-database', menuName: '校园数据库', menuType: 'menu', parentId: 'wise', icon: 'ri-database-2-line', path: 'campus-database', component: '', sortOrder: 8, isVisible: true },
    ...
    { menuKey: 'community:marketplace-category', menuName: '分类管理', menuType: 'menu', parentId: 'community:marketplace', icon: 'ri-price-tag-3-line', path: 'marketplace-category', component: '/community/marketplace-category/index', sortOrder: 1, isVisible: true },
    { menuKey: 'community:marketplace-item', menuName: '商品管理', menuType: 'menu', parentId: 'community:marketplace', icon: 'ri-shopping-bag-line', path: 'marketplace-item', component: '/community/marketplace-item/index', sortOrder: 2, isVisible: true },
    ...
    { menuKey: 'community:alumni', menuName: '校友圈管理', menuType: 'menu', parentId: 'community', icon: 'ri-chat-1-line', path: 'alumni', component: '', sortOrder: 3, isVisible: true },
