...
<template>
  <div
    class="art-card-sm h-32 flex-c px-5 transition-transform duration-200 hover:-translate-y-0.5"
    :class="boxStyle"
  >
    <div class="flex-c flex-1 gap-4 min-w-0">
      <div
        v-if="icon"
        class="size-11 flex-cc rounded-lg text-xl text-white shrink-0"
        :class="iconStyle"
      >
