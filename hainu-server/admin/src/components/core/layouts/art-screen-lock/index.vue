  ...
  <div class="layout-lock-screen">
    ...
    <div v-if="!isLock">
      <ElDialog v-model="visible" :width="370" :show-close="false" @open="handleDialogOpen">
        <div class="flex-c flex-col">
          ...
          <div class="mt-7.5 mb-3.5 text-base font-medium">{{ displayName }}</div>
          <ElForm
            ref="formRef"
            :model="formData"
            :rules="rules"
    ...
    <div v-else class="unlock-content">
      <div class="flex-c flex-col w-80">
        ...
        <div class="mt-3 mb-3.5 text-base font-medium">{{ displayName }}</div>
        <ElForm
          ref="unlockFormRef"
          :model="unlockForm"
          :rules="rules"
...
<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    const pendingOpen = consumeMittEvent('openLockScreen')
