<template>
  <div class="art-card-sm p-5 h-[27rem] mb-5 max-sm:mb-4">
    ...
    <div class="mt-10 space-y-4">
      <div v-for="item in weeklyList" :key="item.title" class="flex-c gap-2.5">
        ...
        <div class="px-3 py-1.5 text-center text-sm rounded" :class="item.valueBgClass">
