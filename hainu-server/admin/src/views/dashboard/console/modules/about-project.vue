<template>
  <div class="art-card-sm p-5 flex-b max-sm:mb-4">
    <div>
      ...
      <div class="flex flex-wrap gap-3.5 max-w-150 mt-9">
        <div
          class="w-60 flex-cb h-12.5 px-3.5 border border-g-300 c-p rounded-lg text-sm bg-g-100/60 duration-300 hover:-translate-y-1 max-sm:w-full"
