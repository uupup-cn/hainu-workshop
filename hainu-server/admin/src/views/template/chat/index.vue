...
<template>
  <div class="page-content flex !p-0 max-md:flex-col" :style="{ height: containerMinHeight }">
    ...
    <div class="chat-sidebar-panel box-border w-90 h-full p-5 max-md:w-full max-md:h-42">
      <span
        class="chat-sidebar-divider absolute top-0 bottom-0 hidden w-px bg-[var(--default-border)] md:block"
      ...
      <ElScrollbar>
        <div
          ...
          :class="{ 'bg-g-200/65': selectedPerson?.id === item.id }"
        ...
        >
          <div class="relative me-3">
            ...
            <div
              class="absolute end-1 bottom-1 size-2 rounded-full"
      ...
      <div class="flex flex-col h-[calc(100%-85px)]">
        ...
        <div class="p-4">
          ...
          <div class="flex-cb mt-3">
            <div class="flex-c">
              <ArtSvgIcon icon="ri:image-line" class="me-5 c-p text-g-600 text-lg" />
              <ArtSvgIcon icon="ri:emotion-happy-line" class="me-5 c-p text-g-600 text-lg" />
            </div>
...
<script setup lang="ts">
  ...
  import aiAvatar from '@/assets/images/avatar/avatar3.webp'
