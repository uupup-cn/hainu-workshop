...
<template>
  <div class="page-content mb-5">
    <ElRow>
      <ElCard class="art-card-sm art-card-border-only w-75 mr-5 mb-7.5" shadow="never">
        <template #header>
      ...
      <ElCard class="art-card-sm art-card-border-only w-75 mb-7.5" shadow="never">
        <template #header>
    ...
    <ElCard class="art-card-sm art-card-border-only mb-7.5" shadow="never">
      <template #header>
