    ...
    <ElCard class="usage-card">
      ...
      <ElCollapse v-model="activeCollapse">
        <ElCollapseItem title="基础用法" name="basic">
          <pre><code class="language-vue" v-text="basicUsageCode"></code></pre>
        </ElCollapseItem>

        <ElCollapseItem title="完整工具栏配置" name="full">
          <pre><code class="language-vue" v-text="fullToolbarCode"></code></pre>
        </ElCollapseItem>

        <ElCollapseItem title="简化工具栏配置" name="simple">
          <pre><code class="language-vue" v-text="simpleToolbarCode"></code></pre>
        </ElCollapseItem>

        <ElCollapseItem title="自定义配置" name="config">
          <pre><code class="language-vue" v-text="customConfigCode"></code></pre>
        </ElCollapseItem>

        <ElCollapseItem title="组件方法调用" name="methods">
          <pre><code class="language-vue" v-text="methodsCode"></code></pre>
        </ElCollapseItem>
...
${scriptCloseTag}`
  ...
  const fullToolbarCode = `<template>
  <!-- 显示所有工具，不排除任何功能 -->
  <ArtWangEditor
    v-model="content"
    :exclude-keys="[]"
  ...
  const simpleToolbarCode = `<template>
  <!-- 只显示基础编辑工具 -->
  <ArtWangEditor
    v-model="content"
    :toolbar-keys="[
