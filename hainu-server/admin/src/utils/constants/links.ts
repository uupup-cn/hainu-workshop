...
export const WEB_LINKS = {
  ...
  // 项目文档
  DOCS: 'https://www.artd.pro/docs/zh/pro/introduce.html',

  // 官网产品介绍页
  PRO_INTRODUCE: 'https://www.artd.pro/docs/zh/pro/introduce.html',

  // 官网定价页
  PRICING: 'https://www.artd.pro/docs/zh/pricing.html',
  ...
  // 项目介绍视频 (Bilibili)
  BILIBILI_VIDEO:
    'https://www.bilibili.com/video/BV1u35G6sEyS/?vd_source=f7f2a5adb02e53a5e7f2acdfaf40058f'
}
