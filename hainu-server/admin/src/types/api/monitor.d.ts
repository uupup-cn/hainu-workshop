declare namespace Api {
  ...
  namespace Monitor {
    ...
    type VisitorAnalyticsRiskLevel = 'LOW' | 'MEDIUM' | 'HIGH'
    type VisitorAnalyticsDeviceType = 'desktop' | 'mobile' | 'tablet'
    type VisitorAnalyticsVisitorType =
      | '稳定办公访客'
      | '移动巡检访客'
      | '夜间活跃访客'
      | '高频切换访客'

    interface VisitorAnalyticsSignalItem {
      /** 显示名称 */
      label: string
      /** 评分 */
      score: number
    ...
    interface VisitorAnalyticsRecord {
      /** ID */
      id: number
      /** 别名 */
      alias: string
      ...
      account: string
      /** 访客类型 */
      visitorType: VisitorAnalyticsVisitorType
      /** 是否来自公开演示账号 */
      ...
      os: string
      /** 设备类型 */
      deviceType: VisitorAnalyticsDeviceType
      /** 设备标签 */
      deviceLabel: string
      /** 置信度 */
      confidence: number
      /** 风险等级 */
      riskLevel: VisitorAnalyticsRiskLevel
      /** 首次访问时间 */
      firstVisitAt: string
      /** 最后访问时间 */
      lastVisitAt: string
      ...
      topPaths: string[]
      /** 识别信号列表 */
      signals: VisitorAnalyticsSignalItem[]
      /** 建议列表 */
      suggestions: string[]
      /** 活跃小时列表 */
      activeHours: number[]
    ...
    interface VisitorAnalyticsSearchParams extends Partial<Api.Common.CommonSearchParams> {
      /** 当前页码 */
      current?: number
      /** 每页条数 */
      size?: number
    ...
    interface VisitorAnalyticsResponse {
      ...
      summary: {
        ...
        visitorCount: number
        /** 业务访客画像数量，不包含公开演示账号 */
        businessVisitorCount: number
        /** 公开演示账号访客画像数量 */
        demoVisitorCount: number
        /** 历史累计疑似访客数量，基于已留存登录日志计算 */
        lifetimeVisitorCount: number
        /** 历史累计公开演示账号疑似访客数量 */
        lifetimeDemoVisitorCount: number
        /** 去重账号数 */
      ...
      records: {
        ...
        total: number
        /** 记录列表 */
        records: VisitorAnalyticsRecord[]
      }
    }
