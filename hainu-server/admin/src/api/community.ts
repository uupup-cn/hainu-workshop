...
export function fetchSetAlumniPostStatus(id: number, isActive: boolean, reason?: string) { return request.put({ url: '/api/v1/admin/alumni/posts/' + id + '/status', data: { isActive, reason }, showSuccessMessage: true }) }
