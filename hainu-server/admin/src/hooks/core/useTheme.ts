...
import { applyThemeCustomizerState, setElementThemeColor } from '@/utils/ui'
...
export function useTheme() {
  ...
  const setSystemTheme = (theme: SystemThemeEnum, themeMode?: SystemThemeEnum) => {
    ...
    settingStore.applyMenuColorModeForTheme(theme)
    setElementThemeColor(settingStore.systemThemeColor)
    applyThemeCustomizerState(settingStore.themeCustomizer)
