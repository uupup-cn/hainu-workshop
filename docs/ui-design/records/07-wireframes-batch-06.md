...
二、新生模块(第二批 · 5 个)
#	页面	关键模块
4	新生模块主页（原新生专题）	4 主入口 + 副入口 + 公告
5	报到流程页	6 步竖排步骤条 + 总进度
6	【已剔除】来校路线页（真实对应：生活攻略-交通）	4 校区切换 + 出行方式 + 路线列表
...
全部页面统计
维度	数量
总页面数	36 个（已剔除一卡通 / 空教室 / 成绩）
框架页	3
新生模块	5
智慧海大	8(主页 + 服务子页 + 数据库，已剔除 3 个非真实)
...
核心组件库(组件补充后 28 个真实组件)
6 批线框,有效 36 个页面（已剔除 3 个非真实页面），覆盖真实页面
