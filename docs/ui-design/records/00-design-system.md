...
> 状态：已确认 ✅
>
> ⚠️ 适用范围：本记录为**小程序端**设计系统。网页端自 v2.3（2026-08-27）起采用独立设计语言（深海蓝 + 阳光金 + 热带青 + 幻紫、全屏官网式布局、Lucide 图标、无 emoji），见 [09-web-design-system.md](09-web-design-system.md)。原"跨端一致 / 小程序与 Web 共用组件库"约束对网页端不再适用。
